...
class LLMTelemetryLog(Base):
    ...
    action_type = Column(String(50), nullable=False, default="dialogue")  # "dialogue", "summarization"
    ...
    estimated_cost_usd = Column(Numeric(12, 6), nullable=False, default=0.0)
    safety_blocked = Column(Boolean, nullable=False, default=False)
